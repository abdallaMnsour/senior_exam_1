                                ...
                                <div class="navbar__wrap main__menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="menu-item-has-children"><a href="#">Our Blog</a>
                                            <ul class="sub-menu">
                                                <li><a href="blog.php">Our News</a></li>
                ...
                <div class="row align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <div class="banner__img text-center text-xxl-end">
                            <img src="<?= isset($_SESSION['person']['image']) ? '../uploads/profile/' . $_SESSION['person']['image'] : 'assets/img/banner/banner_img.png' ?>" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            <h2 class="title wow fadeInUp" data-wow-delay=".2s">hello <?= @$_SESSION['person']['username'] ?? 'user' ?></h2>
                            ...
                            <a href="about.php" class="btn banner__btn wow fadeInUp" data-wow-delay=".6s">more about
                                me</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            ...
                                            <h4 class="title"><a href="portfolio-details.php">Banking Management
                                                    System</a></h4>
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a href="portfolio-details.php">Nature of Business
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a href="portfolio-details.php">Product Design and
                                                    Development</a></h4>
                                            <a href="portfolio-details.php" class="link">Case Study</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a href="portfolio-details.php">Brand strategy System
                                                    Management</a></h4>
                                            <a href="portfolio-details.php" class="link">Case Study</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a href="portfolio-details.php">Visual Design System
                                                    Management</a></h4>
                                            <a href="portfolio-details.php" class="link">Case Study</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>UX/UI Design</span>
                                            <h4 class="title"><a href="portfolio-details.php">Animation Management
                                                    System</a></h4>
                                            <a href="portfolio-details.php" class="link">Case Study</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Design</span>
                                            <h4 class="title"><a href="portfolio-details.php">Graphic Design Management
                                                    System</a></h4>
                                            <a href="portfolio-details.php" class="link">Case Study</a>
                                        </div>
                                    </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            ...
                            <div class="blog__post__content">
                                ...
                                <h3 class="title"><a href="blog-details.php">Facebook design is dedicated to what's new
                                        in design</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            ...
                            <div class="blog__post__content">
                                <span class="date">13 january 2021</span>
                                <h3 class="title"><a href="blog-details.php">Make communication Fast and
                                        Effectively.</a></h3>
                                <a href="blog-details.php" class="read__more">Read mORe</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            ...
                            <div class="blog__post__content">
                                <span class="date">13 january 2021</span>
                                <h3 class="title"><a href="blog-details.php">How to increase your productivity at work
                                        - 2021</a></h3>
                                <a href="blog-details.php" class="read__more">Read mORe</a>
                            </div>
                        </div>
