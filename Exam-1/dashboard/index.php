<?php
session_start();
if (!isset($_SESSION['person']) || $_SESSION['person']['userType'] != 'admin') {
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="../uploads/profile/<?= $admin['image']?>"
                                    alt="Header Avatar">
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        <div class="">
                            <img src="../uploads/profile/<?= $admin['image'] ?>" alt="" class="avatar-md rounded-circle">
                        </div>
                        <div class="mt-3">
